...
namespace transducers {
    ...
    {
        return transduce(std::forward<_Tr>(transducer), details::StreamReducer<_Os>(), std::reference_wrapper<_Os>(output_stream), std::forward<_Ra>(input), nonatomic_escape_hatch());
    }
};